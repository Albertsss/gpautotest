...
<span><em class="time">
<div class="time" id="DBRoleOperatorTest-Time">0 s</div>
</em>DBRoleOperatorTest</span>
                <ul>
                    <li class="level test">
<span><em class="time">
<div class="time" id="DBRoleOperatorTest-createRole-Time">0 s</div>
                        ...
                        <ul>
                            <li class="text">
                                <span class="stdout" id="DBRoleOperatorTest-createRole-Text"></span>
                            </li>
                        </ul>
                    </li>
                    <li class="level test">
<span><em class="time">
<div class="time" id="DBRoleOperatorTest-alterRoleName-Time">0 s</div>
</em><em class="status" id="DBRoleOperatorTest-alterRoleName-Status">not tested</em>alterRoleName()</span>
                        <ul>
                            <li class="text">
                                <span class="stdout" id="DBRoleOperatorTest-alterRoleName-Text"></span>
                            </li>
                        </ul>
                    </li>
                    <li class="level test">
...
</em><em class="status" id="DatabaseOperatorTest-createDatabase-Status">not tested</em>createDatabase()</span>
                        <ul>
                            <li class="text">
                                <span class="stdout" id="DatabaseOperatorTest-createDatabase-Text"></span>
                            </li>
                        </ul>
                    </li>
                    <li class="level test">
<span><em class="time">
<div class="time" id="DatabaseOperatorTest-alterDatabaseName-Time">0 s</div>
</em><em class="status" id="DatabaseOperatorTest-alterDatabaseName-Status">not tested</em>alterDatabaseName()</span>
                        <ul>
                            <li class="text">
                                <span class="stdout" id="DatabaseOperatorTest-alterDatabaseName-Text"></span>
                            </li>
                        </ul>
                    </li>
                    <li class="level test">
...
</em><em class="status" id="DBTestUseCaseObjectTest-setNumericColumn-Status">not tested</em>setNumericColumn()</span>
                        <ul>
                            <li class="text">
                                <span class="stdout" id="DBTestUseCaseObjectTest-setNumericColumn-Text"></span>
                            </li>
                        </ul>
                    </li>
                    <li class="level test">
...
<div class="time" id="DBTestUseCaseObjectTest-setTimeColumn-Time">0 s</div>
                    ...
                    <li class="level test">
<span><em class="time">
<div class="time" id="DBTestUseCaseObjectTest-getCharColumn-Time">0 s</div>
</em><em class="status" id="DBTestUseCaseObjectTest-getCharColumn-Status">not tested</em>getCharColumn()</span>
                        <ul>
                            <li class="text">
                                <span class="stdout" id="DBTestUseCaseObjectTest-getCharColumn-Text"></span>
                            </li>
                        </ul>
                    </li>
                    <li class="level test">
<span><em class="time">
<div class="time" id="DBTestUseCaseObjectTest-getBigIntColumn-Time">0 s</div>
</em><em class="status" id="DBTestUseCaseObjectTest-getBigIntColumn-Status">not tested</em>getBigIntColumn()</span>
                        <ul>
                            <li class="text">
                                <span class="stdout" id="DBTestUseCaseObjectTest-getBigIntColumn-Text"></span>
                            </li>
                        </ul>
                    </li>
                    <li class="level test">
<span><em class="time">
<div class="time" id="DBTestUseCaseObjectTest-getNumericColumn-Time">0 s</div>
</em><em class="status" id="DBTestUseCaseObjectTest-getNumericColumn-Status">not tested</em>getNumericColumn()</span>
                        <ul>
                            <li class="text">
                                <span class="stdout" id="DBTestUseCaseObjectTest-getNumericColumn-Text"></span>
                            </li>
                        </ul>
                    </li>
                    <li class="level test">
...
</em><em class="status" id="DeleteOperatorTest-deleteData-Status">not tested</em>deleteData()</span>
                        <ul>
                            <li class="text">
                                <span class="stdout" id="DeleteOperatorTest-deleteData-Text"></span>
                            </li>
                        </ul>
                    </li>
                </ul>
...
<div class="time" id="InsertOperatorTest-insertData-Time">0 s</div>
</em><em class="status" id="InsertOperatorTest-insertData-Status">not tested</em>insertData()</span>
                        <ul>
                            <li class="text">
                                <span class="stdout" id="InsertOperatorTest-insertData-Text"></span>
                            </li>
                        </ul>
                    </li>
                </ul>
            ...
            <li class="level top open">
<span><em class="time">
<div class="time" id="JDBCConnectionTest-Time">0 s</div>
</em>JDBCConnectionTest</span>
                <ul>
                    <li class="level test">
<span><em class="time">
<div class="time" id="JDBCConnectionTest-getConnection-Time">0 s</div>
</em><em class="status" id="JDBCConnectionTest-getConnection-Status">not tested</em>getConnection()</span>
                        <ul>
                            <li class="text">
                                <span class="stdout" id="JDBCConnectionTest-getConnection-Text"></span>
                            </li>
                        </ul>
                    </li>
                    <li class="level test">
<span><em class="time">
<div class="time" id="JDBCConnectionTest-testSingleParameterConstructor-Time">0 s</div>
</em><em class="status" id="JDBCConnectionTest-testSingleParameterConstructor-Status">not tested</em>testSingleParameterConstructor()</span>
                        <ul>
                            <li class="text">
                                <span class="stdout" id="JDBCConnectionTest-testSingleParameterConstructor-Text"></span>
                            </li>
                        </ul>
                    </li>
                </ul>
            ...
            <li class="level top open">
<span><em class="time">
<div class="time" id="PooledConnectionTest-Time">0 s</div>
</em>PooledConnectionTest</span>
                <ul>
                    <li class="level test">
<span><em class="time">
...
<div class="time" id="PooledConnectionTest-getConnection-Time">0 s</div>
            ...
            <li class="level top open">
<span><em class="time">
<div class="time" id="QueryOperatorTest-Time">0 s</div>
</em>QueryOperatorTest</span>
                <ul>
                    <li class="level test">
<span><em class="time">
<div class="time" id="QueryOperatorTest-freeQuery-Time">0 s</div>
</em><em class="status" id="QueryOperatorTest-freeQuery-Status">not tested</em>freeQuery()</span>
                        <ul>
                            <li class="text">
                                <span class="stdout" id="QueryOperatorTest-freeQuery-Text"></span>
                            </li>
                        </ul>
                    </li>
                    <li class="level test">
...
<div class="time" id="QueryOperatorTest-lessOrEqualQuery-Time">0 s</div>
            ...
            <li class="level top open">
<span><em class="time">
<div class="time" id="SchemaOperatorTest-Time">0 s</div>
</em>SchemaOperatorTest</span>
                <ul>
                    <li class="level test">
<span><em class="time">
...
<div class="time" id="SchemaOperatorTest-alterSchemaName-Time">0 s</div>
                    ...
                    <li class="level test">
<span><em class="time">
<div class="time" id="SchemaOperatorTest-alterSchemaOwner-Time">0 s</div>
</em><em class="status" id="SchemaOperatorTest-alterSchemaOwner-Status">not tested</em>alterSchemaOwner()</span>
                        <ul>
                            <li class="text">
                                <span class="stdout" id="SchemaOperatorTest-alterSchemaOwner-Text"></span>
                            </li>
                        </ul>
                    </li>
                    <li class="level test">
...
</em><em class="status" id="TableOperatorTest-alterTableColumn-Status">not tested</em>alterTableColumn()</span>
                        <ul>
                            <li class="text">
                                <span class="stdout" id="TableOperatorTest-alterTableColumn-Text"></span>
                            </li>
                        </ul>
                    </li>
                    <li class="level test">
<span><em class="time">
<div class="time" id="TableOperatorTest-dropTable-Time">0 s</div>
</em><em class="status" id="TableOperatorTest-dropTable-Status">not tested</em>dropTable()</span>
                        <ul>
                            <li class="text">
            ...
            <li class="level top open">
<span><em class="time">
<div class="time" id="UpdateOperatorTest-Time">0 s</div>
</em>UpdateOperatorTest</span>
                <ul>
                    <li class="level test">
<span><em class="time">
<div class="time" id="UpdateOperatorTest-updateSingleRowData-Time">0 s</div>
</em><em class="status" id="UpdateOperatorTest-updateSingleRowData-Status">not tested</em>updateSingleRowData()</span>
                        <ul>
                            <li class="text">
                                <span class="stdout" id="UpdateOperatorTest-updateSingleRowData-Text"></span>
                            </li>
                        </ul>
                    </li>
                </ul>
...
<div id="footer">
    <p id="foottime">Generated by Linewell on</p>
</div>
</body>
...
//        setMessageInnerHTML("WebSocket连接成功");
        ...
        var timeshow=myDate.getFullYear()+"-"+m+"-"+myDate.getDate()+" "+myDate.toLocaleTimeString();
        $("#foottime").append(timeshow);
    ...
    function setMessageInnerHTML(innerHTML) {
        var coll=innerHTML.split("|");
        if(coll[0]=="className"){
            className = coll[1];
            passTime=0;
        }else if(coll[0]=="methodName"){
            methodName = coll[1];
            document.getElementById(className+"-"+methodName+"-Status").click();
            var com=document.getElementById(className+"-"+methodName+"-Status");
            com.innerHTML="testing";
        }else if(coll[0]=="psql"){
            var com=document.getElementById(className+"-"+methodName+"-Text");
            com.innerHTML=com.innerHTML+"<strong>"+coll[1]+"</strong><br/>";
        }else if(coll[0]=="methodTime"){
            var com=document.getElementById(className+"-"+methodName+"-Time");
            com.innerHTML=coll[1]+" s";
            passTime=passTime+parseFloat(coll[1]);
            passTime=Math.round(passTime * 1000) / 1000;
            document.getElementById(className+"-Time").innerHTML=passTime+" s";
            totalTime=totalTime+parseFloat(coll[1]);
            totalTime=Math.round(totalTime * 1000) / 1000;
            document.getElementById("totalTime").innerHTML=totalTime+" s";
        }else if(coll[0]=="methodStatus"){
            var com=document.getElementById(className+"-"+methodName+"-Status");
            com.innerHTML=coll[1];
            if(coll[1]=="passed"){
                passNum+=1;
                document.getElementById("passNum").innerHTML=passNum+" passed";
            }else{
                com.style.color="red";
                errorNum+=1;
                document.getElementById("errorNum").innerHTML=errorNum+" failed";
            }
        }else if(coll[0]=="errorMsg"){
            var com=document.getElementById(className+"-"+methodName+"-Text");
            com.innerHTML=com.innerHTML+"<strong style='color:red;'>"+coll[1]+"</strong><br/>";
        }
    }
